...
const ContactSec = () => {
    return (
        <>
            <div className="contact w-11/12 my-10 mb-50 flex items-center  m-auto justify-between gap-x-20">
                <div className="left w-1/2">
                    <h1 className="text-[55px] monytserrat-600 font-semibold text-[var(--green-color)] my-5">Reques a Qute</h1>
                ...
                <div className="right w-1/2  flex flex-col gap-y-10">
                    <div className="w-[487px] flex  gap-x-10 items-center justify-center ml-auto">
                        ...
                        <div className="right">
                            ...
                            <p className="montserrat-400 text-[17px]">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptate s.</p>
                        </div>
                    </div>
                    <div className="w-[487px] flex  gap-x-10 items-center justify-center ml-auto">
                        <div className="left">
